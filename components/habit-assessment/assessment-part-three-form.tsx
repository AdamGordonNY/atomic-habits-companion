...
const SECTION_LABELS: Record<number, string> = {
  ...
  5: "Section 2a · Big Picture",
  6: "Section 2a · Big Picture",
  7: "Section 2a · Big Picture",
  8: "Section 2b · Past Habit History",
  9: "Section 2b · Past Habit History",
  10: "Section 2b · Past Habit History",
  11: "Section 2c · Building & Breaking",
